...
/* package */ final class EventLogger
    implements ExoPlayer.EventListener, AudioRendererEventListener, VideoRendererEventListener,
            ...
            if (rendererTrackGroups.length > 0) {
                ...
                for (int groupIndex = 0; groupIndex < rendererTrackGroups.length; groupIndex++) {
                    ...
                    for (int trackIndex = 0; trackIndex < trackGroup.length; trackIndex++) {
                        ...
                        String formatSupport =
                            getFormatSupportString(mappedTrackInfo.getTrackFormatSupport(
                                rendererIndex,
                                groupIndex,
                                trackIndex));
                ...
                if (trackSelection != null) {
                    for (int selectionIndex = 0;
                         selectionIndex < trackSelection.length();
                         selectionIndex++) {
    ...
    private void printMetadata(Metadata metadata, String prefix) {
        for (int i = 0; i < metadata.length(); i++) {
            ...
            if (entry instanceof TextInformationFrame) {
                ...
                Log.d(TAG,
                      prefix + String.format("%s: value=%s",
                                             textInformationFrame.id,
                ...
                Log.d(TAG, prefix + String.format("%s: language=%s, description=%s",
                                                  commentFrame.id,
                                                  commentFrame.language,
    ...
    private static String getTrackStatusString(
        TrackSelection selection, TrackGroup group, int trackIndex) {
